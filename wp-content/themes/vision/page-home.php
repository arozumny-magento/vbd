                    ...
                    <div class="mx-auto md:grid grid-cols-2 gap-0">
                        <div class="bg-<?= $aboutUsStyle ?>-blue block-<?= $aboutUsStyle ?>">
                            <div class="p-6 md:p-10 lg:px-20 lg:py-24 list-trident">
                                <div class="uppercase mb-5 lg:mb-8 !text-xl !lg:text-3xl aos-init aos-animate block-header"
                                     data-aos="fade-up"
                                     data-aos-delay="100">
                        ...
                        <div class="bg-lightblue block-<?= $aboutUsStyle ?>">
                            <div class="p-6 md:p-10 lg:px-20 lg:py-24 list-trident">
                                <div class="uppercase mb-5 lg:mb-8 !text-xl !lg:text-3xl aos-init aos-animate block-header"
                                     data-aos="fade-up"
                                     data-aos-delay="100">
                                    <h3 class="!text-xl !lg:text-3xl !plaakBold"><?= $aboutUs['right_block']['header'] ?? '' ?></h3>
                                </div>
                                <div class="mb-3 lg:mb-8 lg:text-lg aos-init aos-animate block-text" data-aos="fade-up"
                                     data-aos-delay="200">
                ...
                <div class="mx-auto md:grid grid-cols-2 gap-0 services">
                    ...
                    if (have_rows('services')):
                        while (have_rows('services')) : the_row();
                            ...
                            <div class="bg-<?= $leftBlockTheme ?>-blue block-<?= $leftBlockTheme ?> English border-r border-b lg:border-b-0"
                                 style="border-color:#373b61;" onclick="location.href='<?= $leftLink ?>'">
                                <a href="<?= $leftLink ?>" style="display: flex; padding:0; margin: 0;">
                                    <div class="text-white p-6 py-10 md:p-10 lg:px-20 lg:py-24 list-trident">
                                        <div class="uppercase mb-5 lg:mb-8 !text-xl !lg:text-3xl block-header">
                                            ...
                                            <h3 class="!text-xl !lg:text-3xl !plaakBold uppercase pb-2 after:bg-white flex flex-row gap-6 items-center">
                                                <?= $leftHeader ?></h3>

                                        </div>
                                        <div class="flex flex-col justify-between gap-20">
                                            <div class="lg:text-lg aos-init aos-animate block-text" data-aos="fade-up"
                                                 data-aos-delay="100">
                                                <?= $leftText ?>
                                            </div>
                            ...
                            <div class="bg-<?= $rightBlockTheme ?>-blue block-<?= $rightBlockTheme ?> English border-r border-b lg:border-b-0"
                                 style="border-color:#373b61;" onclick="location.href='<?= $rightLink ?>'">
                                <a href="<?= $rightLink ?>" style="display: flex; padding:0; margin: 0;">
                                    <div class="text-white p-6 py-10 md:p-10 lg:px-20 lg:py-24 list-trident">
                                        <div class="uppercase mb-5 lg:mb-8 !text-xl !lg:text-3xl block-header">
                                            <h3 class="!text-xl !lg:text-3xl !plaakBold uppercase pb-2  after:bg-white flex flex-row gap-6 items-center">
                                                <?= $rightHeader ?></h3>
                                ...
                                <div class="text-white p-6 py-10 md:p-10 lg:px-20 lg:py-10 list-trident">
                                    <div class="uppercase mb-5 lg:mb-8 !text-xl !lg:text-3xl block-header flex justify-between">
                                        ...
                                        <div>
                                            ...
                                            if ($logo_url) :
                                                ?>
                                                <span class="testimonial-logo"><img src="<?= esc_url($logo_url) ?>"
                                                                                    alt="<?= esc_attr(get_field('testimonial_author') ?: '') ?>"/></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="flex flex-col justify-between gap-20">
                    ...
                    <div class="mx-auto md:grid grid-cols-2 gap-0">
                        <div class="left-side bg-light-blue">
                            <div class="text-dark-blue p-6 md:p-10 lg:px-20 lg:py-24">
                                <div class="uppercase mb-10 news-container-nav">
                                    <span class="text-lg whitespace-nowrap py-4 px-1 max-w-fit lg:text-xl"
                                          style="font-size: 1.5rem">Testimonials</span>
                                    ...
                                    <?php while ($testimonials->have_posts()) : $testimonials->the_post(); ?>
                                        <div class="slide overflow-hidden">
                                            <div class="mb-5 lg:mb-8 text-xl lg:text-3xl aos-init aos-animate"
                                                ...
                                                <h2 class=""
                                                    style="margin-bottom: 1rem; font-size: 1.5rem"><?= get_field('company') ?></h2>
                        ...
                        <div class="hidden md:block bg-white relative right-side" style="max-height: 100%">
                            <?php if (isset($testimonialsSettings['right_block'])): ?>
                                <img src="<?= $testimonialsSettings['right_block']['background'] ?>" alt=""
                                     class="w-full object-cover">
                                <div class="absolute bottom-[1px] w-full h-2 z-30 aos-init aos-animate"
                                     data-aos="fade-in"
                                     data-aos-delay="300">
                ...
                <div class="bg-dark-blue border-b border-t border-bright-blue partners" id="partners" style="">
                    ...
                    <ul>
                        <?php while (have_rows('partners')) : the_row(); ?>
                            <li><a href="<?= get_sub_field('link') ?>"><img src="<?= get_sub_field('logo') ?>"
                                                                            title="<?= get_sub_field('title') ?>"/></a>
                            </li>
                        <?php endwhile; ?>
                    </ul>
                </div>
                            ...
                            <div class="bg-<?= $newsStyle ?>-blue block-<?= $newsStyle ?> cursor-pointer"
                                ...
                                <a href="<?= get_the_permalink() ?>" style="display: flex; padding:0; margin: 0;">
                                    <div class="text-white p-6 md:p-10 lg:px-20 lg:py-24 list-trident">
                                        ...
                                        <div class="mb-3 lg:mb-8 lg:text-lg aos-init aos-animate block-text"
                                             data-aos="fade-up" data-aos-delay="200">
                                            <?php the_excerpt(); ?>
                                        </div>
                                        <div class="mt-0 space-y-2 !list-none !pl-0 aos-init aos-animate">
