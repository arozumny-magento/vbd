...
if ($events->have_posts()) : ?>
    ...
    <div class="w-full relative content-grid project-grid events-grid">
        <div class="mx-auto md:grid grid-cols-2 gap-0">
            <?php while ($events->have_posts()) : $events->the_post();
                $today = date('Y-m-d H:i:s');
                $is_expired = strtotime(get_field('event_date_time')) <= strtotime($today);
                ...
                ?>
                <a href="<?= get_the_permalink() ?>" style="display: flex;">
