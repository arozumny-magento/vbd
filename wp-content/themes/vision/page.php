        ...
        <div class="umb-block-list">
            ...
            <div class="w-full relative" >
                <div class="mx-auto md:grid grid-cols-2 overflow-hidden gap-0">
                    ...
                    <div class="hidden md:block bg-white relative" style="max-height: 370px;">
            ...
            <div class="w-full relative" >
                <div class="card-grid relative bg-white p-6 md:p-10 lg:py-20 lg:px-20 white-bg">
                    <div class="max-auto text-xl" style="max-width: 1024px; margin: 0 auto">
                        ...
                        <div style="display: none;" class="uppercase mb-10 text-xl lg:text-3xl plaakBold text-dark-blue aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                            <p>Saudi Market Entry</p>
                        </div>

                        <div style="display: none;" class="grid md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-10">
                ...
                <div class="w-full relative" style="display: none;">
                ...
                <div class="card-grid relative bg-white p-6 md:p-10 lg:py-20 lg:px-20 white-bg" style="display: none;">
                    <div class="max-auto">
