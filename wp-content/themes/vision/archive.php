                ...
                <?php while (have_posts()) : the_post(); ?>
                    <div class="column">
                        <a href="<?php echo get_the_permalink(); ?>">
                            <span class="img" style="background: url('<?php echo get_the_post_thumbnail_url(); ?>');"></span>
                            <span class="txt">
                                <span class="author">
                                    <span class="author-image">
                                    <img src="/wp-content/uploads/2025/07/znimok-ekrana-2025-07-17-o-14.05.07.png"  alt="Konstantin Gridin">
                                </span>
                                <span class="author-descr">
                                    <span class="author-descr__name"><?php pll_e('Konstantin Gridin'); ?></span>
                                    <span class="author-descr__time">
                                        <?php echo get_the_date(); ?> | <span class="time"> <?php the_field('time_to_read'); ?></span>
                                    </span>
                                </span>
                            </span>
